...
class WePay {
	...
	/**
	 * API Web physical Endpoint
	 */
    private static $web_server;

	/**
	 * API Server
	 * API Server physical endpoint
	 */
	...
	public static function getAuthorizationUri(array $scope, $redirect_uri, array $options = array()) {
		// User authentication domain is different than the API call domain
	...
	/**
	 * Configure SDK to run against WePay's custom integration servers
	 * @param string $client_id      Your application's client id
	 * @param string $client_secret  Your application's client secret
	 * @param string $api_version    Your application API version
	 * @param string $web_server     Your custom Web server address
	 * @param string $api_server     Your custom API server address
	 * @return void
